...
describe('most favorite blog', () => {
    test('the most favorite blog is', () => {
        const max = listHelper.favoriteBlog(blogs)
        expect(max).toEqual(blogs[2])
    })
})

describe('most productive author', () => {
    test('most productive author is', () => {
        const result = listHelper.mostBlogs(blogs)
        expect(result).toEqual({ author: "Robert C. Martin", blogs: 3 })
    })
})

describe('most favorite author', () => {
    test('most favorite author is', () => {
